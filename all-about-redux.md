...
```
The `state` of any component is always considered to be ***immutable***.  In the first snippet, we see that the `map()` functions returns a new `Array`

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDUxNzk5NjZdfQ==
-->